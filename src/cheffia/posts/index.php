...
<!--básico-->  
        ...
        <!--tags pro favicon-->
           <meta property="og:image" content="../../../img_geral/Banners.png" />
           <link rel="icon" type="image/png" href="../../../img_geral/drawing-1.png" >
...
<div class="row">
  ...
  <hr/>
  <ul>
  <li><a class="active" href="../posts/">post recente:</a></li>
...
foreach($resultado_usuarios as  $row_usuario) {
  ...
  echo "</colgroup>";
   ...
   echo "<tr>";
        ...
        echo "<td>Tabela de commit no.: </td>";
 ...
 echo "</tr>";
        ...
        echo "<tr>";
        echo "<td>repo_name</td>";
    echo "<td>".$row_usuario["repo_name"]."</td>";
...
echo "<td>nmcommit</td>";
    ...
    echo "<td>".$row_usuario["nmcommit"]."</td>";

      echo "</tr>";
        echo "<tr>";
echo "<td>user_1</td>";

 echo "<td>".$row_usuario["user_1"]."</td>";
